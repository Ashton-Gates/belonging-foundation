...
from .models import PitchDeck, Dashboard, Referee, UserApplication, ScholarshipApplication, VendorApplication, Venue, Scholarship  
...
def register_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.save()
            login(request, user)
            return redirect('applicant_dashboard')  # Use the name of the URL pattern
    else:
